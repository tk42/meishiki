...
def test_output_markdown_table(sample):
    meishi, unsei = sample
    result = output_markdown(meishi, unsei, table=True)
    print(result)
    assert result == """# 命式
...
## 干合
- 日柱天干 の「戊」と 月柱蔵干 の「癸」が干合
- 時柱天干 の「戊」と 月柱蔵干 の「癸」が干合
...
## 七冲
- 月柱地支 の「子」が 日柱地支 の「午」を冲する
- 月柱地支 の「子」が 時柱地支 の「午」を冲する

## 刑
- 年柱地支 の「卯」が 月柱地支 の「子」を刑する
- 日柱地支 の「午」が 時柱地支 の「午」を刑する
- 時柱地支 の「午」が 日柱地支 の「午」を刑する
...
def test_output_markdown_table_toki_bashira(sample):
    meishi, unsei = sample
    result = output_markdown(meishi, unsei, table=True, toki_bashira=False)
    print(result)
    assert result == """# 命式
...
def test_output_markdown_table_false(sample):
    meishi, unsei = sample
...
def test_output_markdown_table_false_only_meishiki(sample):
    meishi, unsei = sample
    result = output_markdown(meishi)
    print(result)
    assert result == """# 命式
